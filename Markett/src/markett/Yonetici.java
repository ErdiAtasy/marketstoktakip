...
public class Yonetici extends javax.swing.JFrame {
   ...
   Connection Con = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Yönetici Güncelleme");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(AdminName, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
    ...
    private void UpdateBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UpdateBtnMouseClicked
       if(AdminName.getText().isEmpty() || AdminPass.getText().isEmpty() ){
             ...
             try{
                 ...
                 String Query ="Update serdar.ADMINTBL set ADMINNAME='"+AdminName.getText()+"'"+",ADMINPASS='"+AdminPass.getText()+"'"+"where ID="+1;
